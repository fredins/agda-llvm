o p1: preciseness := precision ?
o p2: "instead of the stack" := "instead of on the stack" 
o p2: "Figure[linebreak]1" - avoid linebreak between Fig and number
  (and similarly with sections).
o p2: "All syn... are not valid" := "Not all syn... are valid"
o p2: I fell the paragraph "The syntax ... language" needs some
  ...
  parenthetic remark).
o Fig. 1: "def" has too much spacing before f.
o §2.1: "The current implementation of GRIN only compiles a subset of
  ...
  "story".)
o The |downFrom| example starts too suddenly.
o "the treeless syntax" is used before it is explained
...
o "The most important GRIN ..." - a bit confusing to first start
  writing about suspended computations and then writing that they
  don't exist.
o p4: "Function nodes need ...": you apply a function to an argument,
  not the other way around.
o downFrom example: I'd like line nunbers, if possible
o I don't understand this part:
  "x35 →
  update x7 x34 ; λ () →
  unit x35":
  why is x7 updated with the same value (x34) as was just fetched from x7?
o "inlining require" := "inlining requires"
...
o "excessive amount" - please be a bit more specific - is it roughly
  linear, quadratic, etc. in the size of the input, etc?
o "We have only implemented" := "Of these, we have only implemented"
o "or by transfer" := "or by transferring"
o "require no" := "requires no"

...
%   weak references. Koka do not handle cycles (Or doesn't have cycles). Roc does not have cycles. Lean? 
...
% - Agda have normal order evaluation. Compiler writers can decide the most efficient evaluation order.

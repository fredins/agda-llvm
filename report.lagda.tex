...
%the interleaved collection strategy result in low memory usage, and a continuous throughput without the pauses of
%\emph{stop-the-world} garbage collectors \citep{jones1996}.


%citet{} Precise reference counting 




% ,which is escpecially true for purely functional languages.

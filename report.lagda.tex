...
% TODO Sometimes we use the shorthand set union notation Γ₁,...,Γₙ  and sometimes we use \bigcup. 
...
\UnaryInfC{\jm{\Delta}{\Gamma}{\lstinline|update| tag x$_n$ v}{\lstinline|update| x$_n$ v}}
\DisplayProof
\\
\vspace{1em}
% UNREACHABLE
...
\UnaryInfC{\jm{\Delta}{\Gamma}{unreachable}{unreachable}}
\DisplayProof
\\
\vspace{1em}
% APP

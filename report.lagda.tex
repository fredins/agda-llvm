...
% FETCH-CTAG-DUP
\AxiomC{x$_0$\;\in\;fv(t)}
\AxiomC{\Gamma′\;=\;\Gamma\;\cap\;fv(t)}
\noLine
\UnaryInfC{\Gamma$_d$\;=\;\Gamma\;-\;\Gamma′}
\AxiomC{\jm{\Delta}{\Gamma′}{t}{t′}}
\RightLabel{\textsc{\stackanchor{fetch-}{\textsc{ctag-dup}}}}
\TrinaryInfC{{\jm{\Delta}{\Gamma}{\lstinline{fetch} ctag x$_m$ [n] ; λ → t}{\lstinline|fetch| ctag x$_m$ [n] ; λ → drop \Gamma$_d$ ; dup x$_0$ ; t′}}}
\DisplayProof
\\
\vspace{1em}
% FETCH-CTAG
...
\TrinaryInfC{\jm{\Delta}{\Gamma}{\lstinline{fetch} ctag x$_m$ [n] ; λ → t}{\lstinline|fetch| ctag x$_m$ [n] ; λ → drop \Gamma$_d$ ; t′}}
\DisplayProof
\\
\vspace{1em}
% FETCH-FTAG
...
\TrinaryInfC{{\jm{\Delta}{\Gamma}{\lstinline{fetch} ftag x$_m$ [n] ; λ → t}{\lstinline|fetch| ftag x$_m$ [n] ; λ → drop \Gamma$_d$ ; t′}}}
\DisplayProof
\\
\vspace{1em}
% APP
...
\UnaryInfC{\jm{\Delta}{\Gamma}{f\;v$_1$...v$_n$}{dup $\bigcup_{i=1}^n\Gamma_{d_i}$\;; f′\;v$_1^\prime$,...,v$_n^\prime$}}
\DisplayProof

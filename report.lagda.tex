...
\newcommand{\biJudgmentDouble}[4]{\BinaryInf$#1\;\mid\;#2\;\vdash\fCenter\;\stackengine{\stackgap}{$#3\rightsquigarrow$}{$#4$}{U}{l}{F}{F}{S}$}
\newcommand{\tiJudgment}[4]{\TrinaryInf$#1\;\mid\;#2\;\vdash\fCenter\;#3\;\rightsquigarrow\;#4$}
...
% TODO
% • Use the new commands \uiJudgment, \axLet...
% • Use \subsequence instead of \bigcup
\begin{figure*}[hptb]
\begin{mdframed}
\centering
% FETCH-OPAQUE
...
\UnaryInfC{\jm{\Delta}{\Gamma}{\lstinline|fetch| x$_m$ [n]}{\lstinline|fetch| x$_m$ [n]}}
\DisplayProof
\\
\vspace{1em}
% ⊥
...
\uiJudgment{\Delta}{\Gamma}{\mbox{\lstinline|update|}\;tag\;x_n\;v}{dup\;\Gamma_d\;;\;\mbox{\lstinline|update|}\;tag\;x_n\;v}
\DisplayProof
\\
\vspace{1em}
% STORE
...
\vspace{1em}
% APP
\AxiomC{\Gamma$_i$\;=\;(\Gamma - $\bigcup_{j=1}^{n-i}\Gamma_{i+j}$)\;\cap\;fv(v$_i$)}
\AxiomC{\jmv{\Delta,\Gamma$_{i+1}$,...,\Gamma$_n$}{\Gamma$_i$}{v$_i$}{\Gamma$_{d_i}$}}
\RightLabel{\textsc{app}}
\BinaryInfC{\jm{\Delta}{\Gamma}{f\;\{v$_1$,...,v$_n$\}}{dup $\bigcup_{i=1}^n\Gamma_{d_i}$\;; f$^\prime$\;\{v$_1^\prime$,...,v$_n^\prime$\}}}
\DisplayProof
\\
\vspace{1em}
% CASE
\AxiomC{\Gamma$_i$\;=\;\Gamma,\;fv(t$_i$)}
\AxiomC{\jm{\Delta}{\Gamma$_i$}{t$_i$}{t$^\prime_i$}}
\RightLabel{\textsc{case}}
\BinaryInfC{\jm{\Delta}{\Gamma}{\lstinline|case|\;v\;t$_1$\;\{tag$_2$\rightarrow\:t$_2$,...,tag$_n$\rightarrow\:t$_n$\}}{\lstinline|case|\;v\;t$^\prime_1$\;\{tag$_2$\rightarrow\:t$^\prime_2$,...,tag$_n$\rightarrow\:t$^\prime_n$\}}}
\DisplayProof
\\
\vspace{1em}
% FETCH-CTAG-DUP
\AxiomC{x$_0$\;\in\;fv(t)}
\AxiomC{\Gamma$^\prime$\;=\;(\Gamma,\;\{x$_0$\})\;\cap\;fv(t)}
\noLine
...
\\
\vspace{1em}
% FETCH-FTAG TODO merge both FTAG
\AxiomC{x$_0$\;\in\;fv(t)}
\AxiomC{\Gamma$^\prime$\;=\;(\Gamma,\;\{x$_0$\})\;\cap\;fv(t)}
\noLine
\UnaryInfC{\Gamma$_d$\;=\;\Gamma\;-\;\Gamma$^\prime$}
...
\AxiomC{\Gamma$^\prime$\;=\;\Gamma\;\cap\;fv(t)}
\noLine
\UnaryInfC{\Gamma$_d$\;=\;(\Gamma\;-\;\Gamma$^\prime$),\;\{x$_0$\}}
\AxiomC{\jm{\Delta}{\Gamma$^\prime$}{t}{t$^\prime$}}
...
\axLet{k}{arity(tag_i)}
\noLine
\uiLet{\Gamma_i}{(\sequence{\Gamma,\{\sequence{x_1,...,x_k}\}})\;\cap\;fv(t_i)}
\noLine
\uiLet{\Gamma^\prime}{(\Gamma\;\cap\;ov(t))\;-\;(\sequence{\Gamma_1,...,\Gamma_n})}
\noLine
\uiLet{\Gamma_{di}}{(\sequence{\Gamma,\{\sequence{x_1,...,x_k}\}})\;-\;\sequence{\Gamma^\prime,\Gamma_i}}
\axJudgment{\sequence{\Delta,\Gamma_{d1},...,\Gamma_{dn},\Gamma_1,...,\Gamma_n}}{\Gamma^\prime}{t}{t^\prime_1}
\noLine
\uiJudgment{\Delta}{\Gamma_i}{t_i}{t^\prime_i}
\RightLabel{\textsc{bind-case}}
\biJudgmentDouble{\Delta}{\Gamma}{% 
  t\;\:;\;\lambda^m\rightarrow\mbox{\lstinline|case|}\;x_{m-1}\;\bot\;\{tag_1\rightarrow\,t_1,...,tag_n\rightarrow\:t_n\}%
  }{%
    t^\prime\;;\;\lambda^m\rightarrow\mbox{\lstinline|case|}\;x_{m-1}\;\bot\;\{\sequence{tag_1\rightarrow\,drop\;\Gamma_{d1}\;;\;t^\prime_1,...,tag_n\rightarrow\,drop\;\Gamma_{dn}\;;\;t^\prime_n\}}%
  }
\DisplayProof
\\
\vspace{1em}

...
main′ = sum (downFrom 100) 
\end{code}
Evaluating (\AgdaFunction{primForce} \AgdaBound{n} \AgdaFunction{\AgdaUnderscore+\AgdaUnderscore} \AgdaBound{m}) prior to the recursive call, achieve several things.
...
\citeauthor{teeuwissen2023}'s implementation in the Roc programming language is the most simliar ours.

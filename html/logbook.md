...
- Added tailcalls with the `tail` attribute in LLVM. LLVM has a `musttail` for  
  ...
  <pre class="Agda">  <a id="1699" class="Keyword">module</a> <a id="DownFromTail"></a><a id="1706" href="logbook.html#1706" class="Module">DownFromTail</a> <a id="1719" class="Keyword">where</a>

    <a id="DownFromTail.downFrom"></a><a id="1730" href="logbook.html#1730" class="Function">downFrom</a> <a id="1739" class="Symbol">:</a> <a id="1741" href="logbook.html#250" class="Datatype">List</a> <a id="1746" href="logbook.html#182" class="Datatype">ℕ</a> <a id="1748" class="Symbol">→</a> <a id="1750" href="logbook.html#182" class="Datatype">ℕ</a> <a id="1752" class="Symbol">→</a> <a id="1754" href="logbook.html#250" class="Datatype">List</a> <a id="1759" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="1765" href="logbook.html#1730" class="Function">downFrom</a> <a id="1774" href="logbook.html#1774" class="Bound">acc</a> <a id="1778" href="Agda.Builtin.Nat.html#204" class="InductiveConstructor">zero</a>    <a id="1786" class="Symbol">=</a> <a id="1788" href="logbook.html#1774" class="Bound">acc</a>
    <a id="1796" href="logbook.html#1730" class="Function">downFrom</a> <a id="1805" href="logbook.html#1805" class="Bound">acc</a> <a id="1809" class="Symbol">(</a><a id="1810" href="Agda.Builtin.Nat.html#217" class="InductiveConstructor">suc</a> <a id="1814" href="logbook.html#1814" class="Bound">n</a><a id="1815" class="Symbol">)</a> <a id="1817" class="Symbol">=</a> <a id="1819" href="logbook.html#1730" class="Function">downFrom</a> <a id="1828" class="Symbol">(</a><a id="1829" href="logbook.html#1814" class="Bound">n</a> <a id="1831" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="1833" href="logbook.html#1805" class="Bound">acc</a><a id="1836" class="Symbol">)</a> <a id="1838" href="logbook.html#1814" class="Bound">n</a>

    <a id="DownFromTail.sum"></a><a id="1845" href="logbook.html#1845" class="Function">sum</a> <a id="1849" class="Symbol">:</a> <a id="1851" href="logbook.html#182" class="Datatype">ℕ</a> <a id="1853" class="Symbol">→</a> <a id="1855" href="logbook.html#250" class="Datatype">List</a> <a id="1860" href="logbook.html#182" class="Datatype">ℕ</a> <a id="1862" class="Symbol">→</a> <a id="1864" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="1870" href="logbook.html#1845" class="Function">sum</a> <a id="1874" href="logbook.html#1874" class="Bound">acc</a> <a id="1878" href="logbook.html#273" class="InductiveConstructor">[]</a> <a id="1881" class="Symbol">=</a> <a id="1883" href="logbook.html#1874" class="Bound">acc</a>
    <a id="1891" href="logbook.html#1845" class="Function">sum</a> <a id="1895" href="logbook.html#1895" class="Bound">acc</a> <a id="1899" class="Symbol">(</a><a id="1900" href="logbook.html#1900" class="Bound">x</a> <a id="1902" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="1904" href="logbook.html#1904" class="Bound">xs</a><a id="1906" class="Symbol">)</a> <a id="1908" class="Symbol">=</a> <a id="1910" href="logbook.html#1845" class="Function">sum</a> <a id="1914" class="Symbol">(</a><a id="1915" href="logbook.html#1900" class="Bound">x</a> <a id="1917" href="Agda.Builtin.Nat.html#319" class="Primitive Operator">+</a> <a id="1919" href="logbook.html#1895" class="Bound">acc</a><a id="1922" class="Symbol">)</a> <a id="1924" href="logbook.html#1904" class="Bound">xs</a>

    <a id="1932" class="Comment">-- Current max: 74 000</a>
    <a id="DownFromTail.main"></a><a id="1959" href="logbook.html#1959" class="Function">main</a> <a id="1964" class="Symbol">=</a> <a id="1966" href="logbook.html#1845" class="Function">sum</a> <a id="1970" class="Number">0</a> <a id="1972" class="Symbol">(</a><a id="1973" href="logbook.html#1730" class="Function">downFrom</a> <a id="1982" href="logbook.html#273" class="InductiveConstructor">[]</a> <a id="1985" class="Number">100</a><a id="1988" class="Symbol">)</a>
</pre>
  ```txt 
  Result: 4950
...
- I wrote another Agda test program which is more suitable for testing reuse. This program  
  ...
  <pre class="Agda">  <a id="8047" class="Keyword">module</a> <a id="Example"></a><a id="8054" href="logbook.html#8054" class="Module">Example</a> <a id="8062" class="Keyword">where</a>

    <a id="Example.downFrom"></a><a id="8073" href="logbook.html#8073" class="Function">downFrom</a> <a id="8082" class="Symbol">:</a> <a id="8084" href="logbook.html#182" class="Datatype">ℕ</a> <a id="8086" class="Symbol">→</a> <a id="8088" href="logbook.html#250" class="Datatype">List</a> <a id="8093" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="8099" href="logbook.html#8073" class="Function">downFrom</a> <a id="8108" href="Agda.Builtin.Nat.html#204" class="InductiveConstructor">zero</a>    <a id="8116" class="Symbol">=</a> <a id="8118" href="logbook.html#273" class="InductiveConstructor">[]</a>
    <a id="8125" href="logbook.html#8073" class="Function">downFrom</a> <a id="8134" class="Symbol">(</a><a id="8135" href="Agda.Builtin.Nat.html#217" class="InductiveConstructor">suc</a> <a id="8139" href="logbook.html#8139" class="Bound">n</a><a id="8140" class="Symbol">)</a> <a id="8142" class="Symbol">=</a> <a id="8144" href="logbook.html#8139" class="Bound">n</a> <a id="8146" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="8148" href="logbook.html#8073" class="Function">downFrom</a> <a id="8157" href="logbook.html#8139" class="Bound">n</a> 

    <a id="Example.mapDouble"></a><a id="8165" href="logbook.html#8165" class="Function">mapDouble</a> <a id="8175" class="Symbol">:</a> <a id="8177" href="logbook.html#250" class="Datatype">List</a> <a id="8182" href="logbook.html#182" class="Datatype">ℕ</a> <a id="8184" class="Symbol">→</a> <a id="8186" href="logbook.html#250" class="Datatype">List</a> <a id="8191" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="8197" href="logbook.html#8165" class="Function">mapDouble</a> <a id="8207" href="logbook.html#273" class="InductiveConstructor">[]</a>       <a id="8216" class="Symbol">=</a> <a id="8218" href="logbook.html#273" class="InductiveConstructor">[]</a>
    <a id="8225" href="logbook.html#8165" class="Function">mapDouble</a> <a id="8235" class="Symbol">(</a><a id="8236" href="logbook.html#8236" class="Bound">x</a> <a id="8238" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="8240" href="logbook.html#8240" class="Bound">xs</a><a id="8242" class="Symbol">)</a> <a id="8244" class="Symbol">=</a> <a id="8246" href="logbook.html#8236" class="Bound">x</a> <a id="8248" href="Agda.Builtin.Nat.html#319" class="Primitive Operator">+</a> <a id="8250" href="logbook.html#8236" class="Bound">x</a> <a id="8252" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="8254" href="logbook.html#8165" class="Function">mapDouble</a> <a id="8264" href="logbook.html#8240" class="Bound">xs</a>

    <a id="Example.sum"></a><a id="8272" href="logbook.html#8272" class="Function">sum</a> <a id="8276" class="Symbol">:</a> <a id="8278" href="logbook.html#250" class="Datatype">List</a> <a id="8283" href="logbook.html#182" class="Datatype">ℕ</a> <a id="8285" class="Symbol">→</a> <a id="8287" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="8293" href="logbook.html#8272" class="Function">sum</a> <a id="8297" href="logbook.html#273" class="InductiveConstructor">[]</a>       <a id="8306" class="Symbol">=</a> <a id="8308" class="Number">0</a>
    <a id="8314" href="logbook.html#8272" class="Function">sum</a> <a id="8318" class="Symbol">(</a><a id="8319" href="logbook.html#8319" class="Bound">x</a> <a id="8321" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="8323" href="logbook.html#8323" class="Bound">xs</a><a id="8325" class="Symbol">)</a> <a id="8327" class="Symbol">=</a> <a id="8329" href="logbook.html#8319" class="Bound">x</a> <a id="8331" href="Agda.Builtin.Nat.html#319" class="Primitive Operator">+</a> <a id="8333" href="logbook.html#8272" class="Function">sum</a> <a id="8337" href="logbook.html#8323" class="Bound">xs</a>

    <a id="Example.main"></a><a id="8345" href="logbook.html#8345" class="Function">main</a> <a id="8350" class="Symbol">=</a> <a id="8352" href="logbook.html#8272" class="Function">sum</a> <a id="8356" class="Symbol">(</a><a id="8357" href="logbook.html#8165" class="Function">mapDouble</a> <a id="8367" class="Symbol">(</a><a id="8368" href="logbook.html#8073" class="Function">downFrom</a> <a id="8377" class="Number">10000</a><a id="8382" class="Symbol">))</a> 
</pre>
...
- Manually translated the the following program first to GRIN and then
  ...
  <pre class="Agda">  <a id="18191" class="Keyword">module</a> <a id="DownFrom"></a><a id="18198" href="logbook.html#18198" class="Module">DownFrom</a> <a id="18207" class="Keyword">where</a>

    <a id="DownFrom.downFrom"></a><a id="18218" href="logbook.html#18218" class="Function">downFrom</a> <a id="18227" class="Symbol">:</a> <a id="18229" href="logbook.html#182" class="Datatype">ℕ</a> <a id="18231" class="Symbol">→</a> <a id="18233" href="logbook.html#250" class="Datatype">List</a> <a id="18238" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="18244" href="logbook.html#18218" class="Function">downFrom</a> <a id="18253" href="Agda.Builtin.Nat.html#204" class="InductiveConstructor">zero</a> <a id="18258" class="Symbol">=</a> <a id="18260" href="logbook.html#273" class="InductiveConstructor">[]</a>
    <a id="18267" href="logbook.html#18218" class="Function">downFrom</a> <a id="18276" class="Symbol">(</a><a id="18277" href="Agda.Builtin.Nat.html#217" class="InductiveConstructor">suc</a> <a id="18281" href="logbook.html#18281" class="Bound">n</a><a id="18282" class="Symbol">)</a> <a id="18284" class="Symbol">=</a> <a id="18286" href="Agda.Builtin.Nat.html#217" class="InductiveConstructor">suc</a> <a id="18290" href="logbook.html#18281" class="Bound">n</a> <a id="18292" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="18294" href="logbook.html#18218" class="Function">downFrom</a> <a id="18303" href="logbook.html#18281" class="Bound">n</a> 

    <a id="DownFrom.sum"></a><a id="18311" href="logbook.html#18311" class="Function">sum</a> <a id="18315" class="Symbol">:</a> <a id="18317" href="logbook.html#250" class="Datatype">List</a> <a id="18322" href="logbook.html#182" class="Datatype">ℕ</a> <a id="18324" class="Symbol">→</a> <a id="18326" href="logbook.html#182" class="Datatype">ℕ</a>
    <a id="18332" href="logbook.html#18311" class="Function">sum</a> <a id="18336" href="logbook.html#273" class="InductiveConstructor">[]</a> <a id="18339" class="Symbol">=</a> <a id="18341" class="Number">0</a>
    <a id="18347" href="logbook.html#18311" class="Function">sum</a> <a id="18351" class="Symbol">(</a><a id="18352" href="logbook.html#18352" class="Bound">x</a> <a id="18354" href="logbook.html#290" class="InductiveConstructor Operator">∷</a> <a id="18356" href="logbook.html#18356" class="Bound">xs</a><a id="18358" class="Symbol">)</a> <a id="18360" class="Symbol">=</a> <a id="18362" href="logbook.html#18352" class="Bound">x</a> <a id="18364" href="Agda.Builtin.Nat.html#319" class="Primitive Operator">+</a> <a id="18366" href="logbook.html#18311" class="Function">sum</a> <a id="18370" href="logbook.html#18356" class="Bound">xs</a>

    <a id="DownFrom.main"></a><a id="18378" href="logbook.html#18378" class="Function">main</a> <a id="18383" class="Symbol">=</a> <a id="18385" href="logbook.html#18311" class="Function">sum</a> <a id="18389" class="Symbol">(</a><a id="18390" href="logbook.html#18218" class="Function">downFrom</a> <a id="18399" class="Number">4</a><a id="18400" class="Symbol">)</a>
</pre>

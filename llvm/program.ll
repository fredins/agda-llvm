...
"CDownFrom.List._∷__2":
  ...
  %24 = call fastcc %Node @"Agda.Builtin.Nat._+_"(i64 %x10, i64 %x60)
  ret %Node %24
default_2:
  unreachable
}
...
@main(){
  ...
  store %Node %3, ptr %4
  %x18 = ptrtoint ptr %4 to i64
  %5 = insertvalue %Node undef, i64 3, 1
  %6 = insertvalue %Node %5, i64 %x18, 2
  ...
  %x19 = extractvalue %Node %9, 2
  call fastcc void @printf(ptr @"%d", i64 %x19)
  ret void
}
